  ...
  return (
    <div>
        ...
        <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="relative z-50">
            ...
            <div className="fixed inset-0 flex items-center justify-center">
                <DialogPanel className="bg-second-bg shadow-2xl rounded-lg w-64 py-8 flex flex-col items-center">
                    ...
                    <img src={imageUrl} alt="avatar" className='h-32 w-32 border-white shadow-2xl border-2 rounded-full object-cover' />
        ...
        <button onClick={() => {setIsOpen(true)}}>
            <img src={imageUrl} alt="avatar" className='h-12 w-12 border-white shadow-2xl border-2 rounded-full object-cover' />
        </button>
    </div>
  )
}
